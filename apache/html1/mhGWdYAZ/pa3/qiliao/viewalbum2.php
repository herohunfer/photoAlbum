...
?>
    ...
    for ($i = 0; $i < $num; ++$i) {
      ...
      echo "
          <td height = '400px' algin='center'>
            <a href='javascript:void(0)' onclick='load(".$num.", ".$i.")'> 
  ...
  ?>
  <?php page_footer(); ?>
<script type="text/javascript" src="draghandler2.js"></script>
<script type="text/javascript">
function load(tot, index) {
	...
	for (var i = 0; i < tot; i++) {
		...
		image.src = "pa1_images/images/football_s" + (i+1).toString() + ".jpg";
		var textP = document.createElement("p");
/* 		textP.style.color = "pink";
		textP.style.position = "absolute";
		textP.style.bottom = "0px"; */
		textP.innerHTML = "football_s" + (i + 1).toString();
