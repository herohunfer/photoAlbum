...
//ini_set( 'session.save_path', '/session1' ); // for debug purposes
...
?> 
<hr> 
<a href=session1.php?p=1&<?php echo $sessName . '=' . session_id();?>>test 1 (printing session value)</a> 
<br> 
<a href=session1.php?p=2&<?php echo $sessName . '=' . session_id();?>>test 2 (kill session)</a>
