document.onmousedown = mymouse_down;
document.onmouseup = mymouse_up;
...
//  console.log(drag);
  ...
  offset_x = px_to_int(drag_title.style.left) - offset_width;
  offset_y = px_to_int(drag_title.style.top);
