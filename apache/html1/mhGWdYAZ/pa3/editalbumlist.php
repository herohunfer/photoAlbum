...
//echo"<input type=\"hidden\" name=\"albumid\" value='$albumid' /> <br>";
 ...
 for ($k = 0; $k < $numU; ++$k) {
  $userAdd = mysql_result($resultU, $k, "username");
...
//  $numcheckowner=mysql_num_rows($checkowner);
   ...
   if (($userAdd!=$owner)){
      echo "<tr>";
      echo "<th><div class = 'usertoadd' usertoadd = $userAdd>$userAdd</div></th>";
      echo "<tr>";
...
<tbody>
  ...
  <?php
    ...
    for ($i = 0; $i < $num ; ++$i) {
      ...
      echo "<div><tr><th><div class='drag_title' >$title</div><div class='drag' albumid = $albumid > Give access to </div> </th><td>$access</td>
...
//put the access user table here, this is a table in table        

//--delete permission-->

echo "<div><p class='text-info'>And Users who have access are:</p>

<div id = '$albumid'> <table>
...
</div></td><td></td><td></td><td></td><td></td></tr></div>"; 
...
<script src="js/pa3_drag_new.js"> </script>
<script src="js/pa3_ajax.js"> </script>
