...
<body>
  ...
  <?php
    ...
    echo "<h3><p class='text-info'>Album: $album_title</p></h3>";
  ?>
  ...
  <?php
      ...
      && in_array($extension, $allowedExts))
    {
      ...
      else
      {
        ...
        {
          echo "File with name ".$_FILES["file"]["name"] . " already exists</font><br>";
        }
        else
        {
          move_uploaded_file($_FILES["file"]["tmp_name"],
            "pa1_images/images/" . $_FILES["file"]["name"]);
          echo "Stored in: " . "pa1_images/images/" . $_FILES["file"]["name"] . "<br>";	  
        }
        ...
        if(mysql_num_rows($in_album) == 0) {
          ...
          if(mysql_num_rows($in_database) == 0) {
            ...
            echo $image_name . " is found already in the photo database" . "<br>";
          }
          ...
          echo $_FILES["file"]["name"] . " is added into the album" . "<br>";
        } else {
          // image already exist in the album...
          echo $_FILES["file"]["name"] . " is already in the album" . "<br>";
        }
