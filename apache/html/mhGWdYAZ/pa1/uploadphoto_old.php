    ...
    if (file_exists("pa1_images/images/" . $_FILES["file"]["name"]))
      ...
      if(mysql_num_rows($in_album) == 0) {
                // photo not exist in the album
						...
						$information =$_FILES["file"]["name"] . " is added into album";
                } else {
                // image already exist in the album...
				$information = $_FILES["file"]["name"] . " is already in album";
                }
...
echo "<a href='editalbum.php?albumid=$albumid'>back to edit album</a><br>";
?>
